...
export async function AddAnnouncemnetType(page) {
    ...
    await page.locator('div').filter({ hasText: /^Announcements$/ }).nth(1).click();
    ...
    await page.getByPlaceholder('Description').fill('MidTerm Exam Date are announce');
...
export async function AddStaffAnnouncemnets(page) {
    ...
    await page.locator('div').filter({ hasText: /^Select Announcement Type$/ }).nth(3).click();
    await page.locator('li').filter({ hasText: 'Exam' }).click();
    await page.getByPlaceholder('Write').click();
    await page.getByPlaceholder('Write').fill('New');
    await page.locator('textarea').click();
    await page.locator('textarea').fill('Date Sheet of midterm exam is announced');
...
export async function AddStudentAnnouncement(page) {
    ...
    await page.locator('label').filter({ hasText: 'In-App Notification *' }).locator('span').nth(1).click();
    await page.locator('div').filter({ hasText: /^Select Announcement Type$/ }).nth(2).click();
    await page.locator('li').filter({ hasText: 'Exam' }).click();
    await page.getByPlaceholder('Write').click();
    await page.getByPlaceholder('Write').fill('new');
    await page.locator('textarea').click();
...
export async function AddGuardianAnnouncement(page) {
    ...
    await page.locator('label').filter({ hasText: 'In-App Notification *' }).locator('span').nth(1).click();
    await page.locator('div:nth-child(7) > div > .min-w-1 > section > div > div').first().click();
    await page.locator('li').filter({ hasText: 'Exam' }).click();
    await page.getByPlaceholder('Write').click();
